...
public class ItemControllerIT extends ServiceIntegrationTest {
	...
	public void findItems() throws Exception {
		...
		ResponseEntity<List<Item>> response = (ResponseEntity<List<Item>>) getTemplate()
				.getForEntity(getBase().toString(), items.getClass());
	...
	public void addItem() throws Exception {
		...
		// when
		ResponseEntity<Item> response = getTemplate().postForEntity(
				getBase().toString(), item, Item.class);
	...
	public void updateItem() throws Exception {
		...
		try {
			getTemplate().put(getBase().toString() + "/{id}", item,
					urlVariables);
